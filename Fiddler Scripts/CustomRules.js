...
class Handlers
{
    public static RulesOption("Use Mocking", "Adapter Mocking")
    var b_UseMocking: boolean = true;
    public static RulesOption("Use Intelligent Mocking", "Adapter Mocking")
    var b_UseIntelligentMocking: boolean = false;
    public static RulesOption("Kill Non-Adapter Traffic", "Adapter Mocking")
    var b_KillNonAdapterTraffic: boolean = false; 
 
    static var al = new AdapterMockingLogic.AdapterLogic();
    ...
    */
    ...
    static function OnBeforeRequest(oSession: Session) {
        ...
        {   
					FiddlerObject.log("Visual Studio 8888 traffic rerouted to Localhost.");
        ...
        if (b_UseMocking)
        {
            al.KillNonAdapterTraffic = b_KillNonAdapterTraffic;
            al.UseIntelligentMocking = b_UseIntelligentMocking;
            al.DoAllMocking(oSession);
        }
